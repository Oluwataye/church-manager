  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => toast({ title: "Coming soon!", description: "Member registration will be available soon." })}>
          Add New Member
        </Button>
      </div>
            ...
            <Card key={member.id} className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{member.individualNames}</p>
                </div>
              </div>
            </Card>
          ))
